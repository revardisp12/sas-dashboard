...
const ROLE_VIEWS: Record<UserRole, ActiveView[]> = {
  super_admin:    ['overview','funnel','performance','sales','crm','product-analysis','google-ads','meta-ads','tiktok-shop','shopee','instagram','tiktok-organic','facebook-organic','settings','kol'],
  admin:          ['overview','funnel','performance','sales','crm','product-analysis','google-ads','meta-ads','tiktok-shop','shopee','instagram','tiktok-organic','facebook-organic','settings','kol'],
